...
interface MealPlansBannerProps {
  isAuthenticated: boolean;
  onCreatePlan: () => void;
}

export function MealPlansBanner({ isAuthenticated, onCreatePlan }: MealPlansBannerProps) {
  return (
    <>
      ...
      {isAuthenticated && (
        <div className="md:hidden">
          <Button onClick={onCreatePlan} size="lg" className="gap-2 w-full">
            <Plus className="w-5 h-5" />
            Nový plán
          </Button>
        </div>
